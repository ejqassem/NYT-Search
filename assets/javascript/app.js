...
$("#search").on("click", function(event) {
  ...
  if($("#term").val && $("#records").val) {
    ...
    url =   "https://api.nytimes.com/svc/search/v2/articlesearch.json?api-key=9d7068958bdf4f8db4b43ee759924b10&q=" + term +"&page=" + page +"&begin-date=" + beginDate;
